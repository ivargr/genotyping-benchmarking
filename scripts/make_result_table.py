...
name_mappings = {"bayestyper": "Bayestyper",
                 "gatk": "GATK",
                 "us": "KAGE",
                 "kageWithGlimpse": "KAGE + GLIMPSE",
                 "kageWithGlimpseN2548all": "KAGE + GLIMPSE",
                 "usN2548all": "KAGE",
                 "usN150all": "KAGE 150",
                 "pangenie": "PanGenie",
                 "malva": "Malva",
...
method_jobs  = {
    ...
    "usN2548all": ["mapI1000", "usN2548all"],
    "kageWithGlimpse": ["glimpse", "mapI1000", "usN2548all"],
    "kageWithGlimpseN2548all": ["glimpse_2548all", "mapI1000", "usN2548all"],
